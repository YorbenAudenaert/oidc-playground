...
public class OidcRestClient implements OidcClient {
    ...
    public OidcRestClient(
            @Value("${spring.security.oauth2.client.provider.adfs.token-uri}") String tokenUri,
            @Value("${spring.security.oauth2.client.registration.adfs.client-id}") String clientId,
            @Value("${spring.security.oauth2.client.registration.adfs.client-secret}") String clientSecret,
